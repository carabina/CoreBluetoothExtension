#
# Be sure to run `pod lib lint CoreBluetoothExtension.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'itanchao' => 'tanchao@mobike.com' }
  s.source           = { :git => 'https://github.com/itanchao/CoreBluetoothExtension.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'CoreBluetoothExtension/Classes/**/*'
  
  # s.resource_bundles = {
  #   'CoreBluetoothExtension' => ['CoreBluetoothExtension/Assets/*.png']
  # }
